...
from parties.importers import NationalElection, NationalPartyImporter
from parties.models import NationalParty
...
class Command(BaseCommand):
    ...
    def import_from_file(self):
        ...
        election = NationalParty(date=date, csv_files=[filepath])
        importer = NationalPartyImporter(
            election=election,
